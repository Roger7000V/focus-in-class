...
1. For Windows 32-bit systems, extract the file to **C:\Windows\System32**. Run ```regsvr32.exe %systemroot%\system32\RICHTX32.OCX``` and ```regsvr32.exe %systemroot%\system32\comdlg32.OCX```.
